...
$querys = "SELECT `c_id`, `bname`, `price`, `title`, `description`, `model`, `kilometer`, `year`, `fuel`, `engine`, `transmission`, `color`, `specifications`, `features`, `Owners`, `image`, `status`, `date_created`, `date_updated` FROM `tbl_car` where status=1";
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li>
                ...
                <li>
                    <a href="managevehicle.php"  class="active">
        ...
        <div class="main" data-setbg="img/hero-bg.jpg">
            ...
            <!-- <h3>Add New Car Entries Here...</h3> -->
                <div class="container">
                    ...
                    <td><img src="../dealer/img/vehicle/<?php echo $rows['image']; ?>" width="40" height="40"></td>
